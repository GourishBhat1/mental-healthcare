                            ...
                            <form class="pt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <label class="form-check-label text-muted mx-auto">
                                ...
                                <div class="mb-4 form-group">
                                    <label class="form-check-label text-muted">
                                        Please tick if you have problems related to any of the following (you can tick more than one)
                                    </label>
                                    <div class="form-check">
                                        <label class="form-check-label text-muted">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <label class="form-check-label text-muted mx-auto">
                                            If yes, enter their names in capital letters, separated by comma
                                        </label>
                                        <input type="text" class="form-control form-control-lg" id="exampleInputUsername1" placeholder="Provide details here">
                                    </div>
                                </div>
