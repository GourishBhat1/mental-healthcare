...
<body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-8 grid-margin transparent">
                          <h3 class="font-weight-bold text-center">Past Assessment</h3>
                            <ul class="list-group">
                                <li class="border border-primary list-group-item d-flex justify-content-between align-items-center">
                                    Assessment 1
                                    <a href="view-assessment.php" class="rounded badge badge-primary badge-pill py-2 px-3">View</a>
                                </li>
                                <li class="border border-primary list-group-item d-flex justify-content-between align-items-center">
                                    Assessment 2
                                    <a href="view-assessment.php" class="rounded badge badge-primary badge-pill py-2 px-3">View</a>
    ...
    var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Assessment 1', 'Assessment 2', 'Assessment 3', 'Assessment 4', 'Assessment 5', 'Assessment 6'],
            datasets: [{
